...
#if WIN32
	strcpy_s( m_szString, strlen ( szString ) + 1, szString);
#else
...
#if WIN32
				strcpy_s ( m_szString, strlen ( Argument.m_szString ) + 1,  Argument.m_szString );
#else
...
#if WIN32
				strcpy_s ( m_szString, sizeLuaString + 1, szLuaString );
#else
